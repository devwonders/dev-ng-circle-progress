...
[Original Package Demo](https://bootsoon.github.io/dev-ng-circle-progress/)

[![demo](https://raw.githubusercontent.com/bootsoon/dev-ng-circle-progress/master/demo.png)](https://bootsoon.github.io/dev-ng-circle-progress/)

## About

Edits to a simple circle progress component created for [angular](https://angular.io) based only on SVG graphics and has various of options to customize it.
...
containerHeight | `string` | `80%` | Height of circle
containerWidth | `string` | `80%` | Width of circle
...
Original MIT © [bootsoon](mailto:bootsoon@aliyun.com)
